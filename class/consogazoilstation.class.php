...
/**
 *  \file       /consogazoil/class/consogazoilstation.class.php
 *  \ingroup    consogazoil
 */
...
class ConsogazoilStation extends CommonObjectConsoGazoil
{
	...
	var $element='consogazoilstation';			//!< Id that identify managed objects
	var $table_element='consogazoil_station';	//!< Name of table without prefix where object is stored
    ...
    function create($user, $notrigger=0)
    {
		...
		if (isset($this->is_pref)) $this->is_pref=trim($this->is_pref);
        ...
        // Insert request
		$sql = "INSERT INTO ".MAIN_DB_PREFIX."consogazoil_station(";
		...
		if (! $error)
        {
            $this->id = $this->db->last_insert_id(MAIN_DB_PREFIX."consogazoil_station");
    ...
    function fetch($id,$ref='')
    {
        ...
        $sql.= " FROM ".MAIN_DB_PREFIX."consogazoil_station as t";
         if (!empty($id)) {
    ...
    function update($user=0, $notrigger=0)
    {
        ...
        // Update request
        $sql = "UPDATE ".MAIN_DB_PREFIX."consogazoil_station SET";
	...
	function delete($user, $notrigger=0)
	{
		...
		if (! $error)
		{
    		$sql = "DELETE FROM ".MAIN_DB_PREFIX."consogazoil_station";
    		$sql.= " WHERE rowid=".$this->id;
	...
	function getNomUrl()
	{
		...
		$url = dol_buildpath('/consogazoil/station/card.php',1).'?id='.$this->id;
