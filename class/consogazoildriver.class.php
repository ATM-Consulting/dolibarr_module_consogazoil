...
/**
 * \file /consogazoil/class/consogazoildriver.class.php
 * \ingroup consogazoil
 */
...
class ConsogazoilDriver extends CommonObjectConsoGazoil {
	...
	var $element = 'consogazoildriver'; // !< Id that identify managed objects
	var $table_element = 'consogazoil_driver'; // !< Name of table without prefix where object is stored
	...
	function create($user, $notrigger = 0) {
		...
		// Insert request
		$sql = "INSERT INTO " . MAIN_DB_PREFIX . "consogazoil_driver(";
		...
		if (! $error) {
			$this->id = $this->db->last_insert_id(MAIN_DB_PREFIX . "consogazoil_driver");
	...
	function update($user = 0, $notrigger = 0) {
		...
		// Update request
		$sql = "UPDATE " . MAIN_DB_PREFIX . "consogazoil_driver SET";
	...
	function delete($user, $notrigger = 0) {
		...
		if (! $error) {
			$sql = "DELETE FROM " . MAIN_DB_PREFIX . "consogazoil_driver";
			$sql .= " WHERE rowid=" . $this->id;
