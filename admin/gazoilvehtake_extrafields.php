...
/**
 * \file gazoil/admin/gazoilvehtake_extrafields.php
 * \ingroup agenda
...
$elementtype = 'consogazoil_vehtake'; // Must be the $table_element of the class that manage extrafield
...
dol_fiche_head($head, 'extrafieldsvehtake', $langs->trans("Module103040Name"), 0, "consogazoil@consogazoil");
