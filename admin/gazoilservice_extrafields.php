...
$elementtype = 'consogazoil_service'; // Must be the $table_element of the class that manage extrafield
...
dol_fiche_head($head, 'extrafieldsservice', $langs->trans("Module103040Name"), 0, "consogazoil@consogazoil");
