...
$elementtype = 'consogazoil_vehiculeservice'; // Must be the $table_element of the class that manage extrafield
...
dol_fiche_head($head, 'extrafieldsvehiculeservice', $langs->trans("Module103040Name"), 0, "consogazoil@consogazoil");
