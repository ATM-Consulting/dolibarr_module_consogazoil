...
$(document).ready(function() {
	$("#list").dataTable( {
		...
		?>
		"oTableTools": {
			"sSwfPath": "<?php echo dol_buildpath('/consogazoil/lib/datatables/extensions/TableTools/swf/copy_csv_xls_pdf.swf',1); ?>"
		},
		...
		"stateSave": true,
		"bServerSide": true,
		"sAjaxSource": "<?php echo dol_buildpath('/consogazoil/station/ajax/list.php',1); ?>"
	});
});
</script>
...
<table cellpadding="0" cellspacing="0" border="0" class="display"
	...
	<thead>
		<tr>
			...
			<?php echo getTitleFieldOfList($langs->trans('ConsoGazIsPref'),1); ?>
			<?php
